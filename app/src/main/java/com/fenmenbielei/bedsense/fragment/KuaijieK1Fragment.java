    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (v.getId()) {
            ...
            case R.id.view_zhihan:
                setTopIconAndTitle(R.drawable.ic_shuimianmoshi, R.string.zhihan);
                if (MotionEvent.ACTION_DOWN == action) {
                    eventDownTime = System.currentTimeMillis();
            ...
            case R.id.view_tingyinyue:
                setTopIconAndTitle(R.drawable.tang, R.string.tingyinyue);
                if (MotionEvent.ACTION_DOWN == action) {
                    sendBlueCmd("FF FF FF FF 05 00 00 00 28 D7 1E");
                }
                break;
            case R.id.view_tuibufangsong:
                setTopIconAndTitle(R.drawable.tangf, R.string.tuibufangsong);
                if (MotionEvent.ACTION_DOWN == action) {
