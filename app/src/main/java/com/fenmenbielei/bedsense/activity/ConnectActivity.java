...
import static com.fenmenbielei.bedsense.MyApplication.HEART_RATE_MEASUREMENT;
...
public class ConnectActivity extends BaseActivity implements TranslucentActionBar.ActionBarClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        titleBar.setData(getString(R.string.blue_equipment), R.mipmap.ic_default_return, null, 0, null, this);
